...
// 	$email_peserta = $user->customer_email;
// }

// $mail->addAddress('minahamdi02@gmail.com');    // Add a recipient
$mail->addAddress('minahamdi02@gmail.com', 'oliver.syauqiez@gmail.com');   // Name is optional
...
<center>
    <table role="presentation" style="width:550px; border-collapse:collapse; border:1px solid #cccccc; border-spacing:0; text-align:left; align-content: center;">
